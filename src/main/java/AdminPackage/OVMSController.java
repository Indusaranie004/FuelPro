...
public class OVMSController extends HttpServlet {
	...
	public void doGet(HttpServletRequest req,HttpServletResponse res ) throws IOException, ServletException {
		...
		// For JSP files (except Admin JSPs), forward to them directly
		if (pathInfo.endsWith(".jsp") && !pathInfo.contains("Admin")) {
		...
		if ("/LoginAdmin".equals(act)) {
			...
			// Only show dashboard for root path "/"
			showDashboard(req,res);
		}
	...
	private void showUpdateForm(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		RequestDispatcher rd=req.getRequestDispatcher("AdminUpdate.jsp");
