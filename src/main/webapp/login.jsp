...
<head>
    ...
    <style>
        body {
            background-image: url('CSS/Images/Home_Background.jpg'); /* Replace with your image URL */
    ...
    <div class="container">
        ...
        <form action="${pageContext.request.contextPath}/LoginServlet" method="post">
            ...
            <div class="register-link">
                <a href="${pageContext.request.contextPath}/ChangePassword.jsp">Forgot Password?</a>
            </div>
