...
<body>
    ...
    <div class="navbar">
        <div class="navbar-items">
            ...
            <a href="Refill.jsp">Refill</a>
            <a href="ServiceBooking.jsp">Maintenance</a>
        ...
        <div class="logout-box">
            ...
            %>
            <a href="Home.jsp" style="color: white; text-decoration: none; margin-left: 10px;">Log Out</a>
        </div>
    </div>
    ...
    <div class="wrapper">
        ...
        <div class="updates-container">
            <div class="update-box" onclick="window.location.href='Refill.jsp';">
                <h2>Refill</h2>
                <p>Get fuel refills conveniently.</p>
            </div>
            <div class="update-box" onclick="window.location.href='ServiceBooking.jsp';">
                <h2>Maintenance</h2>
                <p>Plan your vehicle maintenance easily.</p>
            </div>
            <div class="update-box" onclick="window.location.href='Help.jsp';">
                <h2>Help</h2>
