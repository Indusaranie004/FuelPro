...
<head>
    ...
    <style>
        body {
            background-image: url('CSS/Images/UserProfileBG.avif'); /* Replace with your image URL */
...
<body class="refill-page">
    ...
    <div class="container">
        ...
        %>
            <form action="/FuelStationManagementSystem/UpdateProfileServlet" method="post" style="width: 100%;">
            ...
            <div class="login-link" style="margin-top: 15px;">
                <a href="ChangePassword.jsp">Forgot Password? Change Password</a>
            </div>

            <form action="/FuelStationManagementSystem/DeleteUserServlet" method="post" style="display:inline;">
                <input type="hidden" name="userId" value="<%= currentUser.getUserId() %>">
                <button type="submit" class="btn-yellow" style="background-color: #dc3545;">Delete Account</button> <!-- Delete account button with different color -->
            </form>
